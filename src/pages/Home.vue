...
import Brief from '../partials/Brief.vue'
import Details from '../partials/QuoteDetails.vue'
import CostsList from '../partials/CostsList.vue'
import Terms from '../partials/Terms.vue'
